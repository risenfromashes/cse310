...
std::unique_ptr<Stmt> DeclStmt::create(ParserContext *context, Location loc,
...
std::unique_ptr<Stmt> CompoundStmt::create(ParserContext *context, Location loc,
                                           std::vector<std::unique_ptr<Stmt>> stmts)
{
...
std::unique_ptr<Stmt> IfStmt::create(ParserContext *context, Location loc,
                                     std::unique_ptr<Expr> _cond, std::unique_ptr<Stmt> _if,
...
std::unique_ptr<Stmt> ForStmt::create(ParserContext *context, Location loc, std::unique_ptr<ExprStmt> _init,
                                      std::unique_ptr<ExprStmt> _cond, std::unique_ptr<Expr> _iter)
{
  auto init = _init.release();
  auto cond = _cond.release();
...
std::unique_ptr<Stmt> ReturnStmt::create(ParserContext *context, Location loc, std::unique_ptr<Expr> _expr)
{
  auto expr = _expr.release();
